...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = {
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI | (uint32_t) IOPORT_PIN_P002_PFC_05_USB_OVRCUR)
    },
    {
    ...
    },
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI | (uint32_t) IOPORT_PIN_P052_PFC_0B_USB_VBUSEN)
    },
    {
