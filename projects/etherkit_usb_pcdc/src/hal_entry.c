...
void hal_entry(void)
{
    rt_kprintf("\nHello RT-Thread!\n");
    rt_kprintf("==================================================\n");
    rt_kprintf("This example project is an usb pcdc routine!\n");
    rt_kprintf("==================================================\n");
...
{
    RT_UNUSED(parameter);
    extern void usb_pcdc_example (void);
    usb_pcdc_example();
}

int usb_pcdc_thread_create(void)
{
    rt_thread_t tid;
...
INIT_DEVICE_EXPORT(usb_pcdc_thread_create);
