...
/* end of IoT Cloud */
#define PKG_USING_OPENER
#define PKG_OPENER_HOSTNAME "rtthreaddev"
#define PKG_OPENER_WITH_TRACES
#define PKG_OPENER_TRACE_LEVEL 1
#define PKG_OPENER_ETHERNET_BUFFER_SIZE 512
...
#define PKG_USING_OPENER_LATEST_VERSION
#define PKG_OPENER_VER_NUM 0x99999
#define PKG_USING_OPENER_PORT
#define PKG_USING_OPENER_PORT_LATEST_VERSION
#define PKG_OPENER_PORT_VER_NUM 0x99999
