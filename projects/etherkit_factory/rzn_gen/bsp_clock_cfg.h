...
#define BSP_CFG_FSELXSPI0_DIVSELXSPI0 (BSP_CLOCKS_XSPI0_CLOCK_DIV1_75_0_MHZ) /* XSPI_CLK0 75MHz */
#define BSP_CFG_FSELXSPI1_DIVSELXSPI1 (BSP_CLOCKS_XSPI1_CLOCK_DIV1_75_0_MHZ) /* XSPI_CLK1 75MHz */
