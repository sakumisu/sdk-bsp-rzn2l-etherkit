...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = {
    ...
    },
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI | (uint32_t) IOPORT_PIN_P037_PFC_05_GTIOC5A)
    },
    {
        .pin = BSP_IO_PORT_04_PIN_0,
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI | (uint32_t) IOPORT_PIN_P040_PFC_03_GTIOC5B)
    },
    {
